    ...
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-card border border-border rounded-xl p-4">
          <div className="text-xs text-muted-foreground mb-1">Customers with Debt</div>
        ...
        <div className="bg-card border border-border rounded-xl divide-y divide-border overflow-hidden">
          {filtered.map(c => (
            <div key={c.id} className="flex items-center gap-3 px-4 py-3 hover:bg-muted/20">
              ...
              <div className="text-sm font-bold text-red-600 flex-shrink-0">{formatNaira(c.amount_owed)}</div>
