...
export default function ResetData({ user, onNavigate }: Props) {
  ...
  const doBackup = async () => {
    ...
    setBackup(data as Record<string, unknown[]>);
    setProgress("");
    setStep("backed_up");
  };
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-red-700 mt-1">
              ...
              Products, staff accounts, and suppliers are <strong>preserved</strong>.
      ...
      {step === "confirm" && (
        <div className="bg-card border border-border rounded-xl p-5 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            Stock levels will be reset to their opening quantities.
          </p>
      ...
      {step === "done" && (
        <div className="bg-card border border-border rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            ...
            Stock levels reset to opening quantities.
          </p>
